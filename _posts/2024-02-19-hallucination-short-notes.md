...
2. [Arixv] FACTOOL: Factuality Detection in Generative AI A Tool Augmented Framework for Multi-Task and Multi-Domain Scenarios
   1. 生成式AI的结果的事实错误检测方法，目前存在(1)更广泛的任务在使用生成模型处理时面临越来越大的包含事实错误的风险。(2)生成的文本往往篇幅较长，对个别事实缺乏明确界定的粒度。(3)事实核查过程中可获得的显性证据稀缺。
...
3. [EMNLP] FActScore: Fine-grained Atomic Evaluation of Factual Precision in Long Form Text Generation
