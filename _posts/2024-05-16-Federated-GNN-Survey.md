...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/FedGNN-taxonomy.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    联邦图神经网络的两层分类法，上面是整合方式，下面是数据异质性
</div>
